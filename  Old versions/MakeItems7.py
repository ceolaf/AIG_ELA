    ...
    for tier_code, prompt_text, file_name in tiers:
        ...
        with httpx.Client(timeout=60.0) as client:
            ...
            response = client.post(
                ...
                headers=headers,
                json={"message": {"text": prompt_text}}
            )
            response_text = response.json()['messages'][-1]['text']
            
            # Call AMH's printing/filing function
            PrintToFileAndScreen("Copilot", tier_code, 1, response_text, file_name)
            ...
            for index in range(2, item_per_tier + 1):
                ...
                # Call AMH's printing/filing function
                PrintToFileAndScreen("Copilot", tier_code, index, response_text, file_name)
